...
@EnableJpaRepositories("es.golemdr.tragaldaba.repository")
...
//	}
    ...
    public MessageSource messageSource() {  
    	...
    	messageSource.setBasename("classpath:es/golemdr/tragaldaba/messages/ApplicationResources");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
	      ...
	      em.setPackagesToScan(new String[] { "es.golemdr.tragaldaba.domain" });
